  ...
  const prefix0.VnumTypeReflectable(): new r.ReflectorData(
      ...
      <m.DeclarationMirror>[
        ...
        new r.ImplicitGetterMirrorImpl(
            const prefix0.VnumTypeReflectable(), 0, 0, 0, 5),
        new r.ImplicitGetterMirrorImpl(
            const prefix0.VnumTypeReflectable(), 1, 0, 0, 6),
        new r.ImplicitGetterMirrorImpl(
            const prefix0.VnumTypeReflectable(), 2, 0, 0, 7),
        new r.ImplicitGetterMirrorImpl(
            const prefix0.VnumTypeReflectable(), 3, 0, 0, 8),
        ...
        new r.MethodMirrorImpl(r"fromValue", 1, 1, -1, 6, 1, null,
            const <int>[5, 6], const prefix0.VnumTypeReflectable(), null)
      ],
      <m.ParameterMirror>[
